...
class CombinedNodeProfileTests(unittest.TestCase):
    def test_build_markers_stay_in_sync(self):
        self.assertIn('SCRIPT_BUILD="v271"', KTO)
        self.assertIn('PUSH_BUILD="v271"', PUSH)
        self.assertIn('COLLECTOR_BUILD = "v271"', COLLECTOR)
        self.assertIn('MOBILE443_BUILD="v271"', MOBILE443)
        self.assertIn('ADDITIONAL_IP_BUILD="v271"', ADDITIONAL_IPS)
        self.assertIn('REMNA_EGRESS_BUILD="v271"', REMNA_EGRESS)
        self.assertIn('HAPROXY_BANDWIDTH_BUILD="v271"', HAPROXY_BANDWIDTH)
