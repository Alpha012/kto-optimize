...
class TelegramHaproxyTests(unittest.TestCase):
    ...
    def test_each_route_has_direct_button_and_full_editor(self):
        ...
        self.assertIn("<b>Backend maxconn:</b> <code>фиксировано 15000 на backend</code>", editor_body)
    ...
    def test_route_ip_button_moves_input_and_output_atomically(self):
        ...
        self.assertEqual(changed["server_maxconn"], 15000)
    ...
    def test_route_maxconn_is_canonicalized_during_normalization(self):
        ...
        self.assertEqual(
            ...
            "фиксировано 15000 на backend",
        )
        legacy["server_maxconn"] = 25000
        self.assertEqual(self.collector.normalize_haproxy_route(legacy)["server_maxconn"], 15000)
        self.assertEqual(
    ...
    def test_full_binds_pin_to_route_source_or_primary_ip(self):
        ...
        self.assertTrue(all(route["server_maxconn"] == 15000 for route in pinned))
    ...
    def test_edit_targets_additional_port_only(self):
        ...
        self.assertEqual(extra["server_maxconn"], 15000)
